  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          // Layout & sizing
          "relative h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden",
          ...
          // Position: top
          "mb-1.5 group-data-[position-top=true]/navigation-menu:mb-1.5",
          "group-data-[position-top=true]/navigation-menu:mt-0",
