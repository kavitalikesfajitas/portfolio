...
export type RoseThemedButtonProps = React.ComponentProps<"button"> & {
...
export const RoseThemedButton = forwardRef<HTMLButtonElement, RoseThemedButtonProps>(
...
RoseThemedButton.displayName = "RoseThemedButton";
