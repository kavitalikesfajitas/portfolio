...
export const CenterStickyNav = forwardRef<HTMLDivElement, CenterStickyNavProps>(
  function CenterStickyNav({ isMobile, children }, ref) {
    ...
    const borderRadius = useTransform(progress, range, [
