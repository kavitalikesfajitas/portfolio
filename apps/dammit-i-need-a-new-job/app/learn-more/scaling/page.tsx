...
import ScalingContent from "@/docs/003-scaling-map-to-database.mdx";

export const metadata = {
  title: "When a Map Becomes a Database | Dammit",
  description:
    "How the small map-vs-list refactor and the big database question are the same instinct at two scales.",
};

export default function ScalingArticlePage() {
  return (
